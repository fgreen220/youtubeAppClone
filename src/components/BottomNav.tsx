...
export default function BottomNav(props: any) {
  ...
  const [selectedButton, setSelectedButton] = useState(location.pathname === '/' ? '/ytappclone/' : location.pathname);
  ...
  return (
    <Router>
      ...
      >
        <BottomNavigationAction component={Link} to='/ytappclone/' classes={{root: btnClasses.root, selected: btnClasses.selected, label: btnClasses.label}} label='Home' icon={<Home />} />
